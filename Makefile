...
BPFTOOL ?= bpftool
GO ?= go
PRESERVE_ENV := CASA_RULES_PATH,CASA_EVENTS_LOG_PATH,CASA_SESSIONS_LOG_PATH,CASA_AUDIT_LOG_PATH,CASA_ALERT_LOG_PATH,CASA_BPF_PATH,CASA_PID_PATH,CASA_DEBUG_EVAL
